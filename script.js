...
$('#enviarEmail').click(function (e) { 
    ...
    var mensagem = "Ruan, " + saudacao + "!\n\n" +
                   "Venho através de seu portfólio, podemos conversar?\n\n" +
                   "Desde já, obrigado.";

    var mensagemCodificada = encodeURIComponent(mensagem);

    var mailtoLink = "https://mail.google.com/mail/?view=cm&fs=1&to=mruan309@gmail.com&su=Contato%20atrav%C3%A9s%20do%20portf%C3%B3lio&body=" + mensagemCodificada;
